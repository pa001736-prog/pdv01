...
// Importa a biblioteca oficial do Supabase v2 diretamente do CDN (ESM)
// No navegador, podemos importar módulos de CDNs usando "type=module".
...
export function initSupabase({ url, key } = {}) {
  ...
  supabaseClient = createClient(supaUrl, supaKey)
